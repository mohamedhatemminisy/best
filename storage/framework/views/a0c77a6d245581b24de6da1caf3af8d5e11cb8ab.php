...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="identity" id="identity" placeholder="<?php echo app('translator')->get('receipts.cid'); ?>" class="form-control"
            value="<?php echo e(old('cid', $data->identity)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="phone_one" id="phone_one" placeholder="<?php echo app('translator')->get('receipts.phone_one'); ?>"
            class="form-control" value="<?php echo e(old('phone_one', $data->phone_one)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="phone_two" id="phone_two" placeholder="<?php echo app('translator')->get('receipts.phone_two'); ?>"
            class="form-control" value="<?php echo e(old('phone_two', $data->phone_two)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="Hijri_date_of_birth" id="Hijri_date_of_birth"
            placeholder="<?php echo app('translator')->get('receipts.Hijri_date_of_birth'); ?>" class="form-control"
            value="<?php echo e(old('Hijri_date_of_birth', $data->Hijri_date_of_birth)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="birthday" id="birthday" placeholder="<?php echo app('translator')->get('receipts.birthday'); ?>" class="form-control"
            value="<?php echo e(old('birthday', $data->birthday)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="Hijri_age" id="Hijri_age" placeholder="<?php echo app('translator')->get('receipts.Hijri_age'); ?>"
            class="form-control" value="<?php echo e(old('Hijri_age', $data->Hijri_age)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="birth_age" id="birth_age" placeholder="<?php echo app('translator')->get('receipts.birth_age'); ?>"
            class="form-control" value="<?php echo e(old('birth_age', $data->birth_age)); ?>">
    ...
    <div class="col-3 form-group">
        ...
        <select class="form-control" name="bank_id" id='bank'>
            ...
            <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($bank->id); ?>" <?php if($data->bank_id == $bank->id): ?> selected <?php endif; ?>><?php echo e($bank->name); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="family_members" id="family_members" placeholder="<?php echo app('translator')->get('receipts.family_members'); ?>"
            class="form-control" value="<?php echo e(old('family_members', $data->family_members)); ?>">
    ...
    <div class="col-3 form-group">
        ...
        <textarea name="notes" class="form-control" type="text" rows="2" cols="2"
            placeholder="<?php echo app('translator')->get('receipts.notes'); ?>">
                <?php echo e(old('notes', $data->notes)); ?> </textarea>
...
<?php /**PATH /home/demoyoursite/public_html/minesy/best_edit/resources/views/admin/receipt/editComponents/personal.blade.php ENDPATH**/ ?>