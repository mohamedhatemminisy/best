...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-3 form-group">
            ...
            <input type="text" name="real_planned_nums[]" id="planned_num" placeholder="<?php echo app('translator')->get('receipts.planned_num'); ?>"
                class="form-control" value="<?php echo e(old('real_planned_nums.0')); ?>">
        ...
        <div class="col-3 form-group">
            ...
            <select class="form-control" name="real_city_id" id='city'>
                ...
                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($city->id); ?>" <?php echo e(old('real_city_id.0') == $city->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12 form-group">
            <a class="btn btn-light-success font-weight-bold btn-sm estate_clone text-center" style="height: 35px"><i
                    class="fa fa-plus fa-sm p-0"></i> <?php echo app('translator')->get('receipts.add_real_estate'); ?> </a><br>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/demoyoursite/public_html/minesy/best_edit/resources/views/admin/receipt/components/real_state.blade.php ENDPATH**/ ?>