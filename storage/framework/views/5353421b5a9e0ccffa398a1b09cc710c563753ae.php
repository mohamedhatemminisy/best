		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo e(asset('admin/assets/media/error/bg2.jpg')); ?>);">
				...
				<div class="d-flex flex-row-fluid flex-column justify-content-end align-items-center text-center text-white pb-40">
					<h1 class="display-1 font-weight-bold"><?php echo app('translator')->get('general.errors.not_found_page'); ?></h1>
 				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
...
<?php /**PATH /home/demoyoursite/public_html/minesy/best_edit/resources/views/errors/404.blade.php ENDPATH**/ ?>