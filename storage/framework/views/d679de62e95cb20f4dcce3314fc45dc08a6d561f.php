...
<?php if(count($data->land) > 0): ?>
    <?php $__currentLoopData = $data->land; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $land): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control land_estate_typess" name="land_estate_typess[]" id='land_type_id'>
                        ...
                        <?php $__currentLoopData = $land_type_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $land_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($land_type->id); ?>" <?php if($land->land_type_id == $land_type->id): ?> selected <?php endif; ?>>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_estate_statuss[]" id='land_status_ids'>
                        ...
                        <?php $__currentLoopData = $land_status_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $and_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($and_status->id); ?>" <?php if($land->land_status_id == $and_status->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_planned_nums[]" id="planned_num"
                        placeholder="<?php echo app('translator')->get('receipts.planned_num'); ?>" class="form-control"
                        value="<?php echo e(old('land_planned_nums.0', $land->planned_num)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_piece_nums[]" id="piece_num" placeholder="<?php echo app('translator')->get('receipts.piece_num'); ?>"
                        class="form-control" value="<?php echo e(old('land_piece_nums.0', $land->piece_num)); ?>">
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_city_id[]" id='city'>
                        ...
                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($city->id); ?>" <?php if($land->real_city_id == $city->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_districts[]" id="district" placeholder="<?php echo app('translator')->get('receipts.district'); ?>"
                        class="form-control" value="<?php echo e(old('land_districts.0', $land->district)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_owner_nums[]" id="owner_num" placeholder="<?php echo app('translator')->get('receipts.owner_num'); ?>"
                        class="form-control" value="<?php echo e(old('land_owner_nums.0', $land->owner_num)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_rate_nums[]" id="rate_num" placeholder="<?php echo app('translator')->get('receipts.rate_num'); ?>"
                        class="form-control" value="<?php echo e(old('land_rate_nums.0', $land->rate_num)); ?>">
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_license_type_id[]" id='real_license_type_id'>
                        ...
                        <?php $__currentLoopData = $license_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $license_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($license_type->id); ?>" <?php if($land->real_license_type_id == $license_type->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_license_issue_dates[]" id="license_issue_date"
                        ...
                        value="<?php echo e(old('land_license_issue_dates.0', $land->license_issue_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_license_expiration_dates[]" id="license_expiration_date"
                        ...
                        value="<?php echo e(old('land_license_expiration_dates.0', $land->license_expiration_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_property_prices[]" id="property_price"
                        ...
                        value="<?php echo e(old('land_property_prices.0', $land->property_price)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" name="land_property_notess[]" id="property_notes"
                        ...
                        value="<?php echo e(old('land_property_notess.0', $land->property_notes)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="hidden" name="land_stored_id[]" value="<?php echo e($land->id); ?>">

                <?php echo $__env->make('admin.receipt.editComponents.land_rating', ['land_rate' => $land->rating], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


                <div class="col-12 form-group">

                    <a class="btn btn-light-success font-weight-bold btn-sm land_clone text-center"
                        style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> <?php echo app('translator')->get('receipts.add_land'); ?> </a>
                    <a class="btn btn-light-danger font-weight-bold remove_land_input mr-3" style="height: 35px"><i
        ...
        <div class="row">
            <div class="col-3 form-group">
                ...
                <select class="form-control land_estate_typess" name="land_estate_typess[]" id='land_type_id'>
                    <option disabled selected><?php echo app('translator')->get('receipts.land_type_id'); ?></option>
                    <?php $__currentLoopData = $land_type_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $land_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($land_type->id); ?>"
                            <?php echo e(old('land_estate_typess.0') == $land_type->id ? 'selected' : ''); ?>>
                            <?php echo e($land_type->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['land_type_id'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="land_planned_nums[]" id="planned_num"
                    placeholder="<?php echo app('translator')->get('receipts.planned_num'); ?>" class="form-control"
                    value="<?php echo e(old('land_planned_nums.0')); ?>">
                <?php $__errorArgs = ['planned_num'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <select class="form-control" name="land_city_id" id='city'>
                    ...
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>"
                            <?php echo e(old('land_city_id.0') == $city->id ? 'selected' : ''); ?>>
                            <?php echo e($city->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['city_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="hidden" name="land_stored_id[]" value="">
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Work\best_edit\best_edit\resources\views/admin/receipt/editComponents/land.blade.php ENDPATH**/ ?>