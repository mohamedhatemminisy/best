...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="birthday" id="datepicker" placeholder="<?php echo app('translator')->get('receipts.birthday'); ?>"
            class="form-control " value="<?php echo e(old('birthday', $data->birthday)); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Work\best_edit\best_edit\resources\views/admin/receipt/editComponents/personal.blade.php ENDPATH**/ ?>