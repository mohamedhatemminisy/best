...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="hiring_dates[]" id="hiring_date" placeholder="<?php echo app('translator')->get('receipts.hiring_date'); ?>"
                    class="form-control" value="<?php echo e(old('hiring_dates.0', $salary->hiring_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    <label><?php echo app('translator')->get('receipts.hiring_date'); ?> </label>
                    <input type="text" name="hiring_dates[]" id="hiring_date" placeholder="<?php echo app('translator')->get('receipts.hiring_date'); ?>"
                        class="form-control" value="<?php echo e(old('hiring_date')); ?>">
                    <?php $__errorArgs = ['hiring_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/demoyoursite/public_html/minesy/best_edit/resources/views/admin/receipt/editComponents/financial.blade.php ENDPATH**/ ?>