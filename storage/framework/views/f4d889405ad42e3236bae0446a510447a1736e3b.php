...
<html lang="ar">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo e(asset('admin/assets/media/error/bg2.jpg')); ?>);">
				<!--begin::Content-->
				<div class="d-flex flex-row-fluid flex-column justify-content-end align-items-center text-center text-white pb-40">
					<h1 class="display-1 font-weight-bold"><?php echo app('translator')->get('general.errors.user_does_not_have_the_right_permissions'); ?></h1>
 				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
...
<?php /**PATH F:\Work\best_edit\best_edit\resources\views/errors/403.blade.php ENDPATH**/ ?>