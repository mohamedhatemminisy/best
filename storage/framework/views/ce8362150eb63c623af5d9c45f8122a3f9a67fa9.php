...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-3 form-group">
                ...
                <select class="form-control" name="sponser_ids[]" id='sponser_id'>
                    ...
                    <?php $__currentLoopData = $sponsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($sponser->id); ?>"
                            <?php echo e(old('sponser_id.0') == $sponser->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="commitment_id[]" value="<?php echo e($data->id); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Work\best_edit\best_edit\resources\views/admin/receipt/editComponents/commitment.blade.php ENDPATH**/ ?>