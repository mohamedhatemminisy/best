<?php if(count($data->commitment) > 0): ?>
    ...
    <?php $__currentLoopData = $data->commitment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commitment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="installments[]" id="installment"
                        ...
                        value="<?php echo e(old('installments.0', $commitment->installment)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="product_type_ids[]" id='product_type_id'>
                        <option disabled><?php echo app('translator')->get('receipts.product_type_id'); ?></option>
                        <?php $__currentLoopData = $product_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>" <?php if($commitment->product_type_id == $type->id): ?> selected <?php endif; ?>><?php echo e($type->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="sponser_ids[]" id='sponser_id'>
                        <option disabled><?php echo app('translator')->get('receipts.sponser_id'); ?></option>
                        <?php $__currentLoopData = $sponsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sponser->id); ?>" <?php if($commitment->sponser_id == $sponser->id): ?> selected <?php endif; ?>><?php echo e($sponser->name); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="payment_status_ids[]" id='payment_status_id'>
                        <option disabled><?php echo app('translator')->get('receipts.payment_status_id'); ?></option>
                        <?php $__currentLoopData = $Payment_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($Payment->id); ?>" <?php if($commitment->payment_status_id == $Payment->id): ?> selected <?php endif; ?>><?php echo e($Payment->name); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="early_repayments[]" id="early_repayment"
                        ...
                        value="<?php echo e(old('early_repayments.0', $commitment->early_repayment)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="commitment_totals[]" id="total" placeholder="<?php echo app('translator')->get('receipts.total'); ?>"
                        class="form-control" value="<?php echo e(old('commitment_totals.0', $commitment->total)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="commitment_start_dates[]" id="commitment_start_date"
                        placeholder="<?php echo app('translator')->get('receipts.commitment_start_date'); ?>" class="form-control"
                        value="<?php echo e(old('commitment_start_dates.0', $commitment->commitment_start_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="commitment_end_dates[]" id="commitment_end_date"
                        placeholder="<?php echo app('translator')->get('receipts.commitment_end_date'); ?>" class="form-control"
                        value="<?php echo e(old('commitment_end_dates.0', $commitment->commitment_end_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="remaining_installments_counts[]" id="remaining_installments_count"
                        ...
                        value="<?php echo e(old('remaining_installments_counts.0', $commitment->remaining_installments_count)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="last_payment_dates[]" id="last_payment_date"
                        placeholder="<?php echo app('translator')->get('receipts.last_payment_date'); ?>" class="form-control"
                        value="<?php echo e(old('last_payment_dates.0', $commitment->last_payment_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="commitment_notess[]" id="commitment_notes"
                        ...
                        value="<?php echo e(old('commitment_notess.0', $commitment->notes)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="hidden" name="commitment_id[]" value="<?php echo e($commitment->id); ?>">

                <div class="col-12 form-group">

                    <a class="btn btn-light-success font-weight-bold btn-sm commitment_clone text-center"
                        style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> <?php echo app('translator')->get('receipts.add_commitment'); ?> </a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/demoyoursite/public_html/minesy/best_edit/resources/views/admin/receipt/editComponents/commitment.blade.php ENDPATH**/ ?>