                ...
                <div class="tab-pane fade show " role="tabpanel">
                    ...
                    <div class="col form-group">
                        ...
                        <div class="icon-preview align-items-center" data-toggle="tooltip" title="" data-original-title="Preview of selected Icon" aria-describedby="tooltip765905">
                            <button type="button" class="btn btn-light-success active mr-5" id="GetIconPicker" data-iconpicker-input="input#IconInput" data-iconpicker-preview="i#IconPreview">@lang('general.fields.icon') </button>  <i id="IconPreview" class="fab fa-blogger-b ml-5"></i>
                        </div>
                        <input type="text" class="form-control" hidden  id="IconInput" name="icon" value="{{ old('icon') }}"  placeholder="Hidden etc. input for icon classname" autocomplete="off" spellcheck="false">
                    </div>
