...
@section('module_name') @lang('general.modules.earth_status') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.earth_status') @endsection
@section('create_route') {{ route('earth_status.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'earth_status',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
