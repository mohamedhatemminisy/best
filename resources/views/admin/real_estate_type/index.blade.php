...
@section('module_name') @lang('general.modules.real_estate_type') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.real_estate_type') @endsection
@section('create_route') {{ route('real_estate_type.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'real_estate_type',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
