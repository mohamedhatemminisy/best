...
@section('module_name') @lang('general.modules.bank') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.bank') @endsection
@section('create_route') {{ route('bank.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'bank',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
