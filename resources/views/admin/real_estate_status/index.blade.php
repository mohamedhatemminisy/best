...
@section('module_name') @lang('general.modules.real_estate_status') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.real_estate_status') @endsection
@section('create_route') {{ route('real_estate_status.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'real_estate_status',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
