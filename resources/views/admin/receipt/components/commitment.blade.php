    ...
    <div class="row">
        ...
        <div class="col-3 form-group">
            ...
            <select class="form-control" name="sponser_ids[]" id='sponser_id'>
                ...
                @foreach ($sponsers as $sponser)
                    <option value="{{ $sponser->id }}" {{ old('sponser_id.0') == $sponser->id ? 'selected' : '' }}>
                        {{ $sponser->name }}</option>
                @endforeach
            </select>
            @error('sponser_id')
        ...
        <div class="col-12 form-group">
            ...
            <a class="btn btn-light-success font-weight-bold btn-sm commitment_clone text-center"
                style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_commitment') </a><br>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-3 form-group">
                        ...
                        <select class="form-control" name="product_type_ids[]" id='product_type_id'>
                            <option disabled selected>@lang('receipts.product_type_id')</option>
                            @foreach ($product_description as $product)
                                <option value="{{ $product->id }}" {{ old('product_type_ids.0') == $product->id ? 'selected' : '' }}>
                                    {{ $product->name }}</option>
                            @endforeach
                        </select>
                        @error('product_type_id')
