...
@if (count($estate_rate) > 0)
    @foreach ($estate_rate as $rate)
            ...
            <div class="row">
                <div class="col-3 form-group">
                    ...
                    <select class="form-control real_bank_id" choice_id="emp_rate_choice_id_0" name="real_bank_ids[]"
                        ...
                        @foreach ($banks as $bank)
                            <option value="{{ $bank->id }}" @if ($rate->real_bank_id == $bank->id) selected @endif>{{ $bank->name }}</option>
                        @endforeach
                    </select>
                    @error('real_bank_id')
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_first_rates[]" id="first_rate"
                        ...
                        value="{{ old('real_first_rates.0', $rate->first_rate) }}">
                    @error('first_rate')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_second_rates[]" id="second_rate"
                        ...
                        value="{{ old('real_second_rates.0', $rate->second_rate) }}">
                    @error('second_rate')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_third_rates[]" id="third_rate"
                        ...
                        value="{{ old('real_third_rates.0', $rate->third_rate) }}">
                    @error('third_rate')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_approved_rates[]" id="approved_rate"
                        ...
                        value="{{ old('real_approved_rates.0', $rate->approved_rate) }}">
                    @error('approved_rate')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="real_rate_notess[]" id="rate_notes"
                        ...
                        value="{{ old('real_rate_notess.0', $rate->rate_notes) }}">
                    @error('rate_notes')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-12 form-group">
                    ...
                    <a class="btn btn-light-success font-weight-bold btn-sm real_rate_clone text-center"
                        style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_real_rate')
                    </a>
