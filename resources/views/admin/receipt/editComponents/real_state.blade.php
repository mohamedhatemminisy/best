...
@if (count($data->realEstate) > 0)
    @foreach ($data->realEstate as $estate)
            ...
            <div class="row">
                <div class="col-3 form-group">
                    ...
                    <select class="form-control real_estate_typess" name="real_estate_typess[]" id='real_estate_types'>
                        ...
                        @foreach ($real_estate_types as $real_estate_type)
                            <option value="{{ $real_estate_type->id }}" @if ($estate->real_estate_type_id == $real_estate_type->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="real_estate_statuss[]" id='real_estate_status'>
                        ...
                        @foreach ($real_estate_status as $real_estate_stat)
                            <option value="{{ $real_estate_stat->id }}" @if ($estate->real_estate_status_id == $real_estate_stat->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_planned_nums[]" id="planned_num"
                        placeholder="@lang('receipts.planned_num')" class="form-control"
                        value="{{ old('real_planned_nums.0', $estate->planned_num) }}">
                    @error('planned_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_piece_nums[]" id="piece_num" placeholder="@lang('receipts.piece_num')"
                        class="form-control" value="{{ old('real_piece_nums.0', $estate->piece_num) }}">
                    @error('piece_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="real_city_id[]" id='city'>
                        ...
                        @foreach ($cities as $city)
                            <option value="{{ $city->id }}" @if ($estate->real_city_id == $city->id) selected @endif>
                                {{ $city->name }}</option>
                        @endforeach
                    </select>
                    @error('city_id')
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_districts[]" id="district" placeholder="@lang('receipts.district')"
                        class="form-control" value="{{ old('real_districts.0', $estate->district) }}">
                    @error('district')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_owner_nums[]" id="owner_num" placeholder="@lang('receipts.owner_num')"
                        class="form-control" value="{{ old('real_owner_nums.0', $estate->owner_num) }}">
                    @error('owner_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_rate_nums[]" id="rate_num" placeholder="@lang('receipts.rate_num')"
                        class="form-control" value="{{ old('real_rate_nums.0', $estate->rate_num) }}">
                    @error('rate_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="real_license_type_id[]" id='real_license_type_id'>
                        ...
                        @foreach ($license_types as $license_type)
                            <option value="{{ $license_type->id }}" @if ($estate->real_license_type_id == $license_type->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_license_issue_dates[]" id="license_issue_date"
                        placeholder="@lang('receipts.license_issue_date')" class="form-control"
                        value="{{ old('real_license_issue_dates.0', $estate->license_issue_date) }}">
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_license_expiration_dates[]" id="license_expiration_date"
                        placeholder="@lang('receipts.license_expiration_date')" class="form-control"
                        value="{{ old('real_license_expiration_dates.0', $estate->license_expiration_date) }}">
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="real_property_prices[]" id="property_price"
                        ...
                        value="{{ old('real_property_prices.0', $estate->property_price) }}">
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" name="real_property_notess[]" id="property_notes"
                        ...
                        value="{{ old('real_property_notess.0', $estate->property_notes) }}">
                ...
                <input type="hidden" name="real_stored_id[]" value="{{ $estate->id }}">


                @include('admin.receipt.editComponents.real_rating', ['estate_rate' => $estate->rating])


                <div class="col-12 form-group">

                    <a class="btn btn-light-success font-weight-bold btn-sm estate_clone text-center"
                        style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_real_estate')
                    </a><a class="btn btn-light-danger font-weight-bold remove_real_input mr-3" style="height: 35px"><i
...
@else
    ...
    <div class="clone_real_estate">
        <div class="row">
                ...
                <select class="form-control" name="real_city_id" id='city'>
                    ...
                    @foreach ($cities as $city)
                        <option value="{{ $city->id }}"
                            {{ old('real_city_id.0') == $city->id ? 'selected' : '' }}>
                            {{ $city->name }}</option>
                    @endforeach
                </select>
                @error('city_id')
            ...
            <div class="col-12 form-group">
                <a class="btn btn-light-success font-weight-bold btn-sm estate_clone text-center"
                    style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_real_estate') </a><br>
            </div>
        </div>
        <div class="clone_real_estate_last">
