        ...
        <div class="row clon_salary">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="salary[]" id="basic_salary" placeholder="@lang('receipts.basic_salary')"
                    class="form-control" value="{{ old('salary.0', $salary->basic_salary) }}">
                @error('basic_salary')
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="Allowances_without[]" id="Allowances_without_housing_allowance"
                    ...
                    value="{{ old('Allowances_without.0', $salary->Allowances_without_housing_allowance) }}">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="Monthly_allowance[]" id="Monthly_housing_allowance"
                    ...
                    value="{{ old('Monthly_allowance.0', $salary->Monthly_housing_allowance) }}">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="totals[]" id="total" placeholder="@lang('receipts.total')"
                    class="form-control" value="{{ old('totals.0', $salary->total) }}">
                @error('total')
                    <span class="help-block">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="retirement[]" id="retirement_discount"
                    ...
                    value="{{ old('retirement.0', $salary->retirement_discount) }}">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="other_discount[]" id="other_discounts"
                    placeholder="@lang('receipts.other_discounts')" class="form-control"
                    value="{{ old('other_discount.0', $salary->other_discounts) }}">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="approved_salarys[]" id="approved_salary"
                    ...
                    value="{{ old('approved_salarys.0', $salary->approved_salary) }}">
            ...
            <div class="col-3 form-group">
                ...
                <select class="form-control business_sector_id" choice_id="choice_id_0" name="business_sector_ids[]"
                    ...
                    @foreach ($business_sectors as $sector)
                        <option value="{{ $sector->id }}" @if ($salary->business_sector_id == $sector->id) selected @endif>{{ $sector->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-3 form-group">
                ...
                <select class="form-control employer_id" name="employer_ids[]" id="choice_id_0">
                    ...
                    @foreach ($employers as $employer)
                        <option value="{{ $employer->id }}" @if ($salary->employer_id == $employer->id) selected @endif>{{ $employer->name }}
                        </option>
                    @endforeach
                </select>
                @error('employer_id')
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="job_titles[]" id="job_title" placeholder="@lang('receipts.job_title')"
                    class="form-control" value="{{ old('job_titles.0', $salary->job_title) }}">
                @error('job_title')
                    <span class="help-block">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="hiring_dates[]" id="hiring_date" placeholder="@lang('receipts.hiring_date')"
                    class="form-control disable-date" value="{{ old('hiring_dates.0', $salary->hiring_date) }}">
                @error('hiring_date')
                    <span class="help-block">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" name="Remaining_period_of_retirements[]" id="Remaining_period_of_retirement"
                    ...
                    value="{{ old('Remaining_period_of_retirements.0', $salary->Remaining_period_of_retirement) }}">
            ...
            <div class="col-3 form-group">
                ...
                <select class="form-control" name="bank_salary_transferreds[]" id='bank_salary_transferred'>
                    <option disabled>@lang('receipts.bank_salary_transferred')</option>
                    @foreach ($banks as $bank)
                        <option value="{{ $bank->id }}" @if ($salary->bank_salary_transferred == $bank->id) selected @endif>{{ $bank->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-6 form-group">
                ...
                <textarea name="salary_notes[]" class="form-control" type="text" rows="2" cols="2"
                    placeholder="@lang('receipts.salary_note')">
            {{ old('salary_notes.0', $salary->salary_note) }} </textarea>
                @error('salary_note')
                    <span class="help-block">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-12 form-group">
                <a class="btn btn-light-success font-weight-bold btn-sm related_link text-center"
                    style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_salary') </a>
        ...
        $(document).ready(function() {
            ...
            <div class="row">
                <div class="col-3 form-group">
                    <label>@lang('receipts.basic_salary') </label>
                    <input type="text" name="salary[]"  id="basic_salary" placeholder="@lang('receipts.basic_salary')"
                        class="form-control" value="{{ old('basic_salary') }}">
                    @error('basic_salary')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="Allowances_without[]" id="Allowances_without_housing_allowance"
                        placeholder="@lang('receipts.Allowances_without_housing_allowance')" class="form-control"
                        value="{{ old('Allowances_without_housing_allowance') }}">
                    @error('Allowances_without_housing_allowance')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="Monthly_allowance[]" id="Monthly_housing_allowance"
                        placeholder="@lang('receipts.Monthly_housing_allowance')" class="form-control"
                        value="{{ old('Monthly_housing_allowance') }}">
                    @error('Monthly_housing_allowance')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="other_discount[]" id="other_discounts" placeholder="@lang('receipts.other_discounts')"
                        class="form-control" value="{{ old('other_discounts') }}">
                    @error('other_discounts')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    <label>@lang('receipts.approved_salary') </label>
                    <input type="text" name="approved_salarys[]" id="approved_salary" placeholder="@lang('receipts.approved_salary')"
                        class="form-control" value="{{ old('approved_salary') }}">
                    @error('approved_salary')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    <label>@lang('receipts.hiring_date') </label>
                    <input type="text" name="hiring_dates[]" id="hiring_date" placeholder="@lang('receipts.hiring_date')"
                        class="form-control disable-date" value="{{ old('hiring_date') }}">
                    @error('hiring_date')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="Remaining_period_of_retirements[]" id="Remaining_period_of_retirement"
                        placeholder="@lang('receipts.Remaining_period_of_retirement')" class="form-control"
                        value="{{ old('Remaining_period_of_retirement') }}">
                    @error('Remaining_period_of_retirement')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="bank_salary_transferreds[]" id='bank_salary_transferred'>
                        <option disabled selected>@lang('receipts.bank_salary_transferred')</option>
                        @foreach ($banks as $bank)
                            <option value="{{ $bank->id }}" @if ($data->bank_salary_transferred == $bank->id) selected @endif>{{ $bank->name }}</option>
                        @endforeach
                    </select>
                    @error('bank_salary_transferred')
                        <span class="help-block">
