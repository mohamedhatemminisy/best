<div class="row">
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="phone_one" id="phone_one" placeholder="@lang('receipts.phone_one')"
            class="form-control" value="{{ old('phone_one', $data->phone_one) }}">
        @error('phone_one')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="phone_two" id="phone_two" placeholder="@lang('receipts.phone_two')"
            class="form-control" value="{{ old('phone_two', $data->phone_two) }}">
        @error('phone_two')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="Hijri_date_of_birth" id="Hijri_date_of_birth"
            ...
            value="{{ old('Hijri_date_of_birth', $data->Hijri_date_of_birth) }}">
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="birthday" id="datepicker" placeholder="@lang('receipts.birthday')"
            class="form-control " value="{{ old('birthday', $data->birthday) }}">
        @error('birthday')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="Hijri_age" id="Hijri_age" placeholder="@lang('receipts.Hijri_age')"
            class="form-control" value="{{ old('Hijri_age', $data->Hijri_age) }}">
        @error('Hijri_age')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="birth_age" id="birth_age" placeholder="@lang('receipts.birth_age')"
            class="form-control" value="{{ old('birth_age', $data->birth_age) }}">
        @error('birth_age')
            <span class="help-block">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="col-3 form-group">
        ...
        <select class="form-control" name="bank_id" id='bank'>
            ...
            @foreach ($banks as $bank)
                <option value="{{ $bank->id }}" @if ($data->bank_id == $bank->id) selected @endif>{{ $bank->name }}</option>
            @endforeach
        </select>
        @error('bank_id')
            <span class="help-block">
    ...
    <div class="col-3 form-group">
        ...
        <input type="text" name="family_members" id="family_members" placeholder="@lang('receipts.family_members')"
            class="form-control" value="{{ old('family_members', $data->family_members) }}">
