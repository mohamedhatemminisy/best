            ...
            <div class="row">
                <div class="col-3 form-group">
                    ...
                    <select class="form-control land_estate_typess" name="land_estate_typess[]" id='land_type_id'>
                        ...
                        @foreach ($land_type_ids as $land_type)
                            <option value="{{ $land_type->id }}" @if ($land->land_type_id == $land_type->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_estate_statuss[]" id='land_status_ids'>
                        ...
                        @foreach ($land_status_ids as $and_status)
                            <option value="{{ $and_status->id }}" @if ($land->land_status_id == $and_status->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_planned_nums[]" id="planned_num"
                        ...
                        value="{{ old('land_planned_nums.0', $land->planned_num) }}">
                    @error('planned_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_piece_nums[]" id="piece_num" placeholder="@lang('receipts.piece_num')"
                        class="form-control" value="{{ old('land_piece_nums.0', $land->piece_num) }}">
                    @error('piece_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_city_id[]" id='city'>
                        ...
                        @foreach ($cities as $city)
                            <option value="{{ $city->id }}" @if ($land->real_city_id == $city->id) selected @endif>
                                {{ $city->name }}</option>
                        @endforeach
                    </select>
                    @error('city_id')
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_districts[]" id="district" placeholder="@lang('receipts.district')"
                        class="form-control" value="{{ old('land_districts.0', $land->district) }}">
                    @error('district')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_owner_nums[]" id="owner_num" placeholder="@lang('receipts.owner_num')"
                        class="form-control" value="{{ old('land_owner_nums.0', $land->owner_num) }}">
                    @error('owner_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_rate_nums[]" id="rate_num" placeholder="@lang('receipts.rate_num')"
                        class="form-control" value="{{ old('land_rate_nums.0', $land->rate_num) }}">
                    @error('rate_num')
                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-3 form-group">
                    ...
                    <select class="form-control" name="land_license_type_id[]" id='real_license_type_id'>
                        ...
                        @foreach ($license_types as $license_type)
                            <option value="{{ $license_type->id }}" @if ($land->real_license_type_id == $license_type->id) selected @endif>
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_license_issue_dates[]" id="license_issue_date"
                        ...
                        value="{{ old('land_license_issue_dates.0', $land->license_issue_date) }}">
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_license_expiration_dates[]" id="license_expiration_date"
                        ...
                        value="{{ old('land_license_expiration_dates.0', $land->license_expiration_date) }}">
                ...
                <div class="col-3 form-group">
                    ...
                    <input type="text" name="land_property_prices[]" id="property_price"
                        ...
                        value="{{ old('land_property_prices.0', $land->property_price) }}">
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" name="land_property_notess[]" id="property_notes"
                        ...
                        value="{{ old('land_property_notess.0', $land->property_notes) }}">
                ...
                <input type="hidden" name="land_stored_id[]" value="{{ $land->id }}">

                @include('admin.receipt.editComponents.land_rating', ['land_rate' => $land->rating])


                <div class="col-12 form-group">

                    <a class="btn btn-light-success font-weight-bold btn-sm land_clone text-center"
                        style="height: 35px"><i class="fa fa-plus fa-sm p-0"></i> @lang('receipts.add_land') </a>
                ...
                <select class="form-control land_estate_typess" name="land_estate_typess[]" id='land_type_id'>
                    ...
                    @foreach ($land_type_ids as $land_type)
                        <option value="{{ $land_type->id }}"
                            {{ old('land_estate_typess.0') == $land_type->id ? 'selected' : '' }}>
                            {{ $land_type->name }}</option>
                    @endforeach
                </select>
                @error('land_type_id')
                ...
                <select class="form-control" name="land_city_id" id='city'>
                    ...
                    @foreach ($cities as $city)
                        <option value="{{ $city->id }}"
                            {{ old('land_city_id.0') == $city->id ? 'selected' : '' }}>
                            {{ $city->name }}</option>
                    @endforeach
                </select>
                @error('city_id')
