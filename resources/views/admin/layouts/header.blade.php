	...
	<head><base href="">
	 ...
	 <title>الحسبة المثلى - لوحة التحكم </title>
		...
		@if(app()->getLocale() == 'ar')
            ...
            <link href="{{ asset('admin') }}/assets/date/css/bootstrap-datetimepicker.css" rel="stylesheet" />
		...
		@else
            ...
            <link href="{{ asset('admin') }}/assets/plugins/custom/datatables.bundle.css" rel="stylesheet" type="text/css" />
			<!--end::Global Theme Styles-->
			<!--begin::Layout Themes(used by all pages)-->
