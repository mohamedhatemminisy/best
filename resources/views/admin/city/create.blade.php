...
@section('module_name', trans('city.city'))
@section('index_route', route('city.index'))
@section('store_route', route('city.store'))
@section('page_type', trans('general.locales.add_new'))
@section('form_type', 'POST')
@section('title') @lang('city.city') @endsection
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            <div class="col form-group">
                ...
                <input type="text" name="name" placeholder="@lang('city.name')" class="form-control "
                    value="{{ old('name') }}">
            </div>
