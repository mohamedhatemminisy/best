...
@section('module_name') @lang('general.modules.city') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.city') @endsection
@section('create_route') {{ route('city.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'city',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
