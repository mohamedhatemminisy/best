...
@section('module_name') @lang('general.modules.employer') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.employer') @endsection
@section('create_route') {{ route('employer.create') }} @endsection
{{-- Table Content --}}
    ...
    <table class="table table-bordered table-checkable" id="kt_datatable">
        <thead>
            <tr>
                ...
                <th scope="col">@lang('receipts.business_sector_id')</th>
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'employer',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
