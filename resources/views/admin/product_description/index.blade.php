...
@section('module_name') @lang('general.modules.product_description') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.product_description') @endsection
@section('create_route') {{ route('product_description.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'product_description',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
