...
@section('module_name') @lang('general.modules.license_type') @endsection
@section('permission', 'organization')
@section('title') @lang('general.modules.license_type') @endsection
@section('create_route') {{ route('license_type.create') }} @endsection
{{-- Table Content --}}
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'license_type',
                        'value'=>$value])
                    </td>
                </tr>
            @endforeach
